...
//BASE DE DATOS
var productos = ["Pag completa", "Soporte", "Mantenimiento", "Pagina Simple", "Logo", "Asesoramiento"];
var imgGrandes = ["./MFS.png", "./MFS.png","./MFS.png","./MFS.png","./MFS.png","./MFS.png"];
var imgPeque = ["./MFS.png", "./MFS.png","./MFS.png","./MFS.png","./MFS.png","./MFS.png"];
var precios = [150,50,100,75,50,25]
var stock = [5, 2, 8, 3, 10, 4];
var precioTransporte = [2, 4, 6, "gratis"];
var IVA = 0.18;
var uniUser;
